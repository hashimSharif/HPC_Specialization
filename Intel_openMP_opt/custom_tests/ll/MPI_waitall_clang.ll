...
if.then5:                                         ; preds = %if.then
  %call6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str, i32 0, i32 0), i32 8)
  br label %if.end
...
if.then10:                                        ; preds = %if.end8
  ...
  %call11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.1, i32 0, i32 0), i32 %5)
...
for.body:                                         ; preds = %for.cond
  ...
  %call13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.2, i32 0, i32 0), i32 %8, i32 %9)
...
for.end:                                          ; preds = %for.cond
  ...
  %call18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([47 x i8], [47 x i8]* @.str.3, i32 0, i32 0), i32 %16)
  store i32 1, i32* %i, align 4
  br label %for.cond19
...
for.body21:                                       ; preds = %for.cond19
  ...
  %arrayidx23 = getelementptr inbounds [8 x i32], [8 x i32]* %y, i64 0, i64 %idxprom22
  %20 = bitcast i32* %arrayidx23 to i8*
  %21 = load i32, i32* %tag, align 4
  %22 = load i32, i32* %i, align 4
  %idxprom24 = sext i32 %22 to i64
  %arrayidx25 = getelementptr inbounds [8 x i32], [8 x i32]* %recv_req, i64 0, i64 %idxprom24
  %call26 = call i32 @MPI_Irecv(i8* %20, i32 1, i32 1275069445, i32 -2, i32 %21, i32 1140850688, i32* %arrayidx25)
  br label %for.inc27
...
for.end29:                                        ; preds = %for.cond19
  ...
  %arrayidx31 = getelementptr inbounds [8 x i32], [8 x i32]* %recv_req, i64 0, i64 1
  %arrayidx32 = getelementptr inbounds [8 x %struct.MPI_Status], [8 x %struct.MPI_Status]* %status, i64 0, i64 1
  %call33 = call i32 @MPI_Waitall(i32 %sub30, i32* %arrayidx31, %struct.MPI_Status* %arrayidx32)
  store i32 1, i32* %i, align 4
  br label %for.cond34

for.cond34:                                       ; preds = %for.inc40, %for.end29
  %25 = load i32, i32* %i, align 4
  %26 = load i32, i32* %np, align 4
  %cmp35 = icmp slt i32 %25, %26
  br i1 %cmp35, label %for.body36, label %for.end42

for.body36:                                       ; preds = %for.cond34
  %27 = load i32, i32* %me, align 4
  %28 = load i32, i32* %i, align 4
  %idxprom37 = sext i32 %28 to i64
  %arrayidx38 = getelementptr inbounds [8 x i32], [8 x i32]* %y, i64 0, i64 %idxprom37
  %29 = load i32, i32* %arrayidx38, align 4
  %call39 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([47 x i8], [47 x i8]* @.str.4, i32 0, i32 0), i32 %27, i32 %29)
  br label %for.inc40
...
for.end42:                                        ; preds = %for.cond34
  ...
  %call43 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.5, i32 0, i32 0), i32 %31)
...
if.else:                                          ; preds = %if.end8
  %32 = bitcast [8 x i32]* %y to i8*
  %33 = load i32, i32* %tag, align 4
  %arrayidx44 = getelementptr inbounds [8 x i32], [8 x i32]* %recv_req, i64 0, i64 0
  %call45 = call i32 @MPI_Irecv(i8* %32, i32 1, i32 1275069445, i32 0, i32 %33, i32 1140850688, i32* %arrayidx44)
  %arrayidx46 = getelementptr inbounds [8 x i32], [8 x i32]* %recv_req, i64 0, i64 0
  %arrayidx47 = getelementptr inbounds [8 x %struct.MPI_Status], [8 x %struct.MPI_Status]* %status, i64 0, i64 0
  %call48 = call i32 @MPI_Wait(i32* %arrayidx46, %struct.MPI_Status* %arrayidx47)
  %34 = bitcast i32* %x to i8*
  %35 = load i32, i32* %tag, align 4
  %arrayidx49 = getelementptr inbounds [8 x i32], [8 x i32]* %send_req, i64 0, i64 0
  %call50 = call i32 @MPI_Isend(i8* %34, i32 1, i32 1275069445, i32 0, i32 %35, i32 1140850688, i32* %arrayidx49)
  %arrayidx51 = getelementptr inbounds [8 x i32], [8 x i32]* %send_req, i64 0, i64 0
  %arrayidx52 = getelementptr inbounds [8 x %struct.MPI_Status], [8 x %struct.MPI_Status]* %status, i64 0, i64 0
  %call53 = call i32 @MPI_Wait(i32* %arrayidx51, %struct.MPI_Status* %arrayidx52)
  br label %if.end54

if.end54:                                         ; preds = %if.else, %for.end42
  %call55 = call i32 @MPI_Finalize()
  call void @exit(i32 0) #3
  unreachable
...
declare void @__kmpc_fork_call_end(%ident_t*, i32, void (i32*, i32*, ...)*, ...)
