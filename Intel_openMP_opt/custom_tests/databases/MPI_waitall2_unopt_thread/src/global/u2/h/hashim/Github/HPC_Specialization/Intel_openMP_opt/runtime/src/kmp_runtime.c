...
#endif /* OMP_40_ENABLED */
    {
        printf("---- master before signalling any childre calling internal fork --- \n");
...
#endif /* OMP_40_ENABLED */
    {
        printf("---- master before signalling any children calling internal fork --- \n");
        __kmp_internal_fork2( loc, gtid, team );
...
void
__kmp_internal_fork2( ident_t *id, int gtid, kmp_team_t *team )
{
    kmp_info_t *this_thr = __kmp_threads[gtid];
