...
# mark_description "-I/opt/cray/libsci/16.07.1/INTEL/15.0/x86_64/include -I/opt/cray/mpt/7.4.1/gni/sma/include -I/opt/cray/mpt/7";
# mark_description ".4.1/gni/mpich-intel/15.0/include -I/opt/cray/pmi/5.0.10-1.0000.11050.0.0.ari/include -I/opt/cray/python/3.3";
# mark_description ".2/include/python3.3m -I/opt/cray/rca/1.0.0-2.0502.57212.2.56.ari/include -I/opt/cray/alps/5.2.3-2.0502.9295";
# mark_description ".14.14.ari/include -I/opt/cray/xpmem/0.1-2.0502.57015.1.15.ari/include -I/opt/cray/gni-headers/4.0-1.0502.10";
# mark_description "317.9.2.ari/include -I/opt/cray/dmapp/7.0.1-1.0502.10246.8.47.ari/include -I/opt/cray/ugni/6.0-1.0502.10245.";
# mark_description "9.9.ari/include -I/opt/cray/udreg/2.3.2-1.0502.9889.2.20.ari/include -I/usr/local/include -I/opt/cray/wlm_de";
# mark_description "tect/1.0-1.0502.57063.1.1.ari/include -I/opt/cray/krca/1.0.0-2.0502.57202.2.45.ari/include -I/opt/cray-hss-d";
# mark_description "evel/7.2.0/include -xCORE-AVX-I -static -D__CRAYXC -D__CRAY_IVYBRIDGE -D__CRAYXT_COMPUTE_LINUX_TARGET -S -o ";
# mark_description "custom_tests/hello.s -openmp";
	.file "hello.c"
	.text
..TXTST0:
