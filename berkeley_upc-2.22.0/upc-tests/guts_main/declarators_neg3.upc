...
{
    /*
     * To check that "shared" can not appear in a declarator which has
     * automatic storage duration, unless it qualifies a pointer type
...
/* This function definition is not valid because of shared type declaration in function context */
int
foo(){
    shared int b;
    return 0;
