################################################################################
################################################################################
# NOTE: This is just a recent version of the standard Perl Getopt::Long module.
#       We use this renamed version for upcc because some machines use an older
#       version that does not handle long flags correctly when a single dash is
#       used and a value is passed with '=' (ex: --network=smp).
#       Even this library doesn't handle some other cases (ex: -DFOO=BAR), but
#       we work around them in upcc.pl.
################################################################################
################################################################################
